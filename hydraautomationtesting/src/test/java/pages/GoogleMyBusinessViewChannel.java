...
public class GoogleMyBusinessViewChannel {
	
	WebDriver driver;

	public GoogleMyBusinessViewChannel(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//div[text()='HiHydraPOC']")
	public WebElement businessChannelName;
